...
public class SelfJpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean produceSelfDbClientEntityManager() {
        ...
        em.setPackagesToScan("com.unityhealth.api.domain.self");
